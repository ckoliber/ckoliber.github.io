              ...
              ...[
                ...
                [`.${color}`]: {
                  ...
                  "[data-name=bg]": {
                    ...
                    filter: `drop-shadow(0 0 4px ${(theme.colors as any)[
                      color
                    ].bg(5, {
                      alpha: 0.5,
                    })})`,
                ...
                [`.${color}:is(h1,h2,h3,h4,h5,h6)`]: {
                  color: (theme.colors as any)[color].main(5),
                  textShadow: `0 0 2px ${(theme.colors as any)[color].main(5)}`,
                },
                [`.${color}:is(button)`]: {
                  color: (theme.colors as any)[color].text(2),
                  textShadow: `0 0 2px ${(theme.colors as any)[color].text(2)}`,

                  ":hover": {
                    color: (theme.colors as any)[color].text(1),
                    textShadow: `0 0 2px ${(theme.colors as any)[color].text(
                      1,
                    )}`,
                    "[data-name=bg]": {
                      color: (theme.colors as any)[color].bg(1, {
                        alpha: 0.5,
                      }),
                      filter: `drop-shadow(0 0 4px ${(theme.colors as any)[
                        color
                    ...
                    "[data-name=line]": {
                      color: (theme.colors as any)[color].main(1),
                      filter: `drop-shadow(0 0 4px ${(theme.colors as any)[
                        color
                      ].main(1)})`,
                    },
                ...
                [`.${color}:is(hr)`]: {
                  backgroundColor: (theme.colors as any)[color].main(5),
                  boxShadow: `0 0 2px ${(theme.colors as any)[color].main(5)}`,
                },
              })),
            ),
          }}
