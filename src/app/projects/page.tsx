  ...
  return (
    <>
      ...
      >
        <ul>
          <li>
            Seamless Huma integration: register a repository and get CRUD routes
            generated for your model
          </li>
          <li>
            Endpoints out of the box: GET list/by-id, POST, PUT, DELETE for any
            model
          </li>
          <li>
          ...
          <li>
            Customizable before/after hooks per method to enforce business rules
            and side effects
          </li>
          <li>
            Flexible config per method (Get/Put/Post/Delete modes) to enable
            bulk/single behaviors
          </li>
          <li>
            Relation filtering: query parents by child fields via declared
            relations
          </li>
          <li>
            Custom field operations: add type-safe operators (e.g., _regexp,
            _iregexp) on selected fields
          </li>
        </ul>
      </Card>
      <Card date="" title="Ravand BPMS" subtitle="Personal Project" location="">
        <ul>
          <li>
            UI platform built on Camunda 8 (Zeebe) with advanced forms renderer
            and DMS integrations
          </li>
          <li>BPMN viewer/editor using BPMN.io with custom extensions</li>
          <li>
            Tech: Vite, React, BPMN.io, GitHub Actions, Semantic Release,
            Renovate, DevContainers
          </li>
        </ul>
      </Card>
      <Card date="" title="Ansible Roles" subtitle="Open Source" location="">
        <ul>
          <li>
            <a
            ...
            : Installs Docker and bootstraps a Swarm with managers/workers,
            overlay network, and prune cron
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/ansible-role-swarm"
              target="_blank"
          ...
          <li>
            ...
            : Installs and configures WireGuard Site-to-Site VPN on multiple
            servers
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/ansible-role-wireguard"
      ...
      >
        <ul>
          <li>
            ...
            (Swarm/Kubernetes/Nomad) with server groups and load balancers
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/terraform-google-cluster"
              target="_blank"
          ...
          <li>
            ...
            : Creates VPCs, subnets, routes, and firewall rules on Google Cloud
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/terraform-google-network"
              target="_blank"
          ...
          <li>
            ...
            : Creates networks, subnets, routes, and firewalls on Hetzner Cloud
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/terraform-hcloud-network"
              target="_blank"
          ...
          <li>
            ...
            (Swarm/Kubernetes/Nomad) with servers, volumes, and load balancers
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/terraform-hcloud-cluster"
              target="_blank"
          ...
          <li>
            ...
            : Generates dynamic inventory from SSH/WinRM connections and runs
            ansible-playbook from Terraform
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/terraform-module-ansible"
              target="_blank"
          ...
          <li>
            ...
            : Bootstraps K3s/RKE2 clusters over SSH/WinRM (an alternative to
            k3sup)
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/terraform-module-rke"
          ...
          <li>
            ...
            : Provisions K3s/RKE2 on Hetzner Cloud and installs CCM, CSI, and
            Cluster Autoscaler
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/terraform-hcloud-rke"
          ...
          <li>
            ...
            : Provisions namespaced environments (quota, registry secret) in
            Kubernetes
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/terraform-kubernetes-environment"
          ...
          <li>
            ...
            : Manages GitLab groups, projects, and default organization policies
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/terraform-gitlab-application"
              target="_blank"
      ...
      >
        <ul>
          <li>
            ...
            authentication, authorization, validation, nested create/update
            <Link
              className="ml-2"
              href="https://github.com/loopback4/loopback-component-crud"
              target="_blank"
          ...
          <li>
            ...
            : Repository mixin to filter records based on user/context rules
            <Link
              className="ml-2"
              href="https://github.com/loopback4/loopback-component-filter"
              target="_blank"
          ...
          <li>
            ...
            : Adds temporal history to models via HistoryEntity/Repository,
          ...
          <li>
            ...
            : Repository mixin for cascading create/update/delete across
            relations
            <Link
              className="ml-2"
              href="https://github.com/loopback4/loopback-component-cascade"
          ...
          <li>
            ...
            : HRBAC authorization for LoopBack 4 with decorators, repositories,
            and mixins
            <Link
              className="ml-2"
              href="https://github.com/loopback4/loopback-component-authorization"
      ...
      >
        <ul>
          <li>
            ...
            : React Admin data provider for LoopBack 4; supports includes and
            custom HTTP client
            <Link
              className="ml-2"
              href="https://github.com/loopback4/ra-data-lb4"
          ...
          <li>
            ...
            : Mixes multiple data providers/resources into one React Admin
            provider with per-resource filters
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/ra-data-mixer"
              target="_blank"
          ...
          <li>
            ...
            : React Admin data provider for ProcessMaker 3 APIs; supports custom
            HTTP client
            <Link
              className="ml-2"
              href="https://github.com/ckoliber/ra-data-processmaker3"
      ...
      >
        <ul>
          ...
          <li>
            Implemented Hole Punching for P2P connections in audio/video calls
            with Erlang
          </li>
          <li>
          ...
          <li>
            Streamed audio/video frames using Android native APIs, FFMPEG, and
            raw sockets
          </li>
          <li>
            Built an Android messenger app with Java, C (JNI), and Android
            Studio
          </li>
          <li>Developed a desktop messenger app using Qt, C++, and QML</li>
        </ul>
      </Card>
    </>
  );
  ...
  return (
    <>
      ...
      >
        <ul>
          <li>
            Training N-Gram Language Model on Hamshahri v2 dataset (Persian
            Newspaper) using NLTK
            <Link
              className="ml-2"
          ...
          <li>
            Implementation of Hidden-Markov-Model from scratch in python (Baum
            Welch Algorithm, Viterbi Algorithm)
            <Link
              className="ml-2"
      ...
      >
        <ul>
          <li>
            Applying Geometrical Operation, Histogram Equalization, Filtering in
            Spacial and Frequency domain, and Morphological Operation using
            OpenCV
            <Link
              className="ml-2"
          ...
          <li>
            Blast Cell Image Classification into Normal and Abnormal using a CNN
            Model
            <Link
              className="ml-2"
          ...
          <li>
            CIFAR10 Classification using a Nested-Hierarchical Transformer
            (NesT)
            <Link
              className="ml-2"
      ...
      >
        <ul>
          <li>
            Implementation of perceptron from scratch using Python and NumPy and
            applying it on Polynomial Regression problem
            <Link
              className="ml-2"
          ...
          <li>
            Training perceptron for Money Classification into Real and Fake
            classes
            <Link
              className="ml-2"
          ...
          <li>
            Implementation of Linear-Discriminant-Analysis using Python and
            NumPy and applying it to reducing dimension and visualizing data
            <Link
              className="ml-2"
          ...
          <li>
            Implementation of Principal-Component-Analysis using Python and
            NumPy and applying it to Face Image dataset compression and
            reconstruction
            <Link
              className="ml-2"
          ...
          <li>
            Applying Logistic Regression for a binary classification task on
            Income dataset
            <Link
              className="ml-2"
          ...
          <li>
            Applying K-Means clustering method on dataset and visualizing
            clusters
            <Link
              className="ml-2"
          ...
          <li>
            Activity Recognition using Wearable Physiological Signal Features
            using Decision Tree, Random Forest, XGBoost, and SVM Classifiers
            <Link
              className="ml-2"
          ...
          <li>
            Parkinson&apos;s Disease Detection using Speech Signal Features
            using Decision Tree, Random Forest, XGBoost, SVM, MLP, ELM, and
            Autoencoder
            <Link
              className="ml-2"
          ...
          <li>
            Heart Disease Prediction from Health Indicators using Decision Tree,
            Random Forest, XGBoost, SVM, MLP, ELM, and Autoencoder
            <Link
              className="ml-2"
      ...
      >
        <ul>
          ...
          <li>
            Implementation of Davis Language encoder and decoder for Universal
            Programs
            <Link
              className="ml-2"
      ...
      >
        <ul>
          <li>
            Implementation of Cross Platform Async Socket Server (TCP, UDP) in C
            <Link
              className="ml-2"
          ...
          <li>
            Implementation of Thread Pool and Process Pool design patterns in C
          ...
          <li>
            Implementation of Cross Platform IPC Tools (Semaphores, Shared
            Memories, Message Queues) in C
            <Link
              className="ml-2"
      ...
      >
        <ul>
          ...
          <li>
            Huffman Compressor desktop application using C++, Qt, QML
            <Link
              className="ml-2"
          ...
          <li>
            Implementation of Basic Data Structures (ArrayList, LinkedList,
            Stack, Queue, Deque) in C
            <Link
              className="ml-2"
      ...
      >
        <ul>
          ...
          <li>
            Implementation of Govara Assets Manager using C++, Qt, QML
            <Link
              className="ml-2"
