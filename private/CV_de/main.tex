...
\begin{section}{Berufserfahrung}
  \begin{subsection}{Gridfuse.com}{DevOps Engineer}{Nov 2025 -- Heute}{}
     \item Etablierte SNMP-Monitoring für Hardware-Geräte über mehrere Regionen hinweg
     \item Erstellte Grafana-Dashboards für Infrastruktur-, Netzwerk- und Systemmetriken
     \item Deployte und verwaltete OpenWebUI mit OpenRouter-Integration
     \item Verbesserte CI/CD und Developer Experience mit mise für CI, IDE und CDE
     \item Führte Mend Renovate CE ein und ersetzte bestehende Renovate-Pipelines
     \item Betrieb Kubernetes-Plattformen mit GitLab CI, Helm, ArgoCD und AWS ECR
 \end{subsection}

 \begin{subsection}{Visiwise.co}{Senior DevOps Engineer}{Mai 2022 -- Oct 2025}{}
