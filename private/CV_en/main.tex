...
\begin{section}{Work Experience}
  \begin{subsection}{Gridfuse.com}{DevOps Engineer}{Nov 2025 -- Present}{}
     \item Set up SNMP monitoring for hardware devices across multiple regions
     \item Built Grafana dashboards for infrastructure, network devices, logs, and metrics
     ...
     \item Operated Kubernetes platforms using GitLab CI, Helm, ArgoCD, and AWS ECR
 \end{subsection}

 \begin{subsection}{Visiwise.co}{Senior DevOps Engineer}{May 2022 -- Oct 2025}{}
