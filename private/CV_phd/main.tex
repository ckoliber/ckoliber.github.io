...
\begin{section}{Work Experience}
  \begin{subsection}{Gridfuse.com}{DevOps Engineer}{Nov 2025 -- Present}{Leipzig, Germany}
     \item Set up SNMP monitoring for hardware devices across multiple regions
     \item Built Grafana dashboards for infrastructure, network, logs, and metrics
     \item Deployed and managed OpenWebUI integrated with OpenRouter
     \item Improved CI/CD and developer experience using mise across CI, IDE, and CDE
     \item Introduced Mend Renovate CE and replaced legacy Renovate pipelines
     \item Operated Kubernetes platforms with GitLab CI, Helm, ArgoCD, and AWS ECR
 \end{subsection}
 \begin{subsection}{Visiwise.co}{Senior DevOps Engineer}{May 2022 -- Oct 2025}{Calgary, Canada}
