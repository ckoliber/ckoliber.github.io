...
\begin{section}{Teaching Experience}
 ...
 \begin{subsection}{Advanced Programming}{Prof. Arash Ahadi}{Feb 2019 -- Jun 2019}{Kharazmi University}
     \item Taught memory management in C and the Object-Oriented paradigm in C (OOC) \;\href{https://github.com/hoomaanx/ooc_lecture}{\faExternalLink*}
     \item Taught basic concepts of computer graphics and OpenGL programming in C \;\href{https://github.com/hoomaanx/opengl}{\faExternalLink*}
 ...
 \begin{subsection}{Basic Programming}{Prof. Saeed Reza Kheradpisheh}{Sep 2018 -- Jan 2019}{Kharazmi University}
     ...
     \item Organized and managed homework assignments for mentees \;\href{https://github.com/hoomaanx/Phy97Sources}{\faExternalLink*}
 \end{subsection}
\end{section}
